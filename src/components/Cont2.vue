      ...
      <div class="slider-container">
        <div class="slider">
          ...
          <div class="slides">
            ...
            <div class="slide">
              <img src="/src/assets/2.png" alt="Image 3">
            </div>
          </div>
        </div>
      </div>
...
.navigation {
  position: absolute;
  bottom: 0; /* Расположение кнопок навигации снизу */
  /*top: 0; !* Расположение кнопок навигации сверху *!
  left: 0; !* Выравнивание кнопок навигации по левому краю *!*/
  width: 300px;
  display: flex;
